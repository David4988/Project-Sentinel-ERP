        ...
        {!student.dataSharing ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              This student has not granted permission to share their academic
              data with advisors. Data sharing consent is required to view
              detailed analytics.
            </p>
          </div>
        ) : (
    ...
    <div className="space-y-16 animate-fade-in">
      {classNames.map((className) => {
        ...
        const recentComplaints = complaints.filter(
          (complaint) => complaint.class === className
        );
        return (
          <div key={className} className="space-y-8">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">
                {className} Class Analytics
              </h1>
              <p className="text-gray-600">
                Detailed wellbeing analysis for {className} students
              </p>
            </div>
                  ...
                  {classInfo.students.map((student) => (
                    <Dialog key={student.id}>
                      <DialogTrigger asChild>
                        <Card
                          className={`cursor-pointer transition-all hover:shadow-md ${getStudentRiskColor(
                            student.riskLevel
                          )}`}
                        >
                          <CardContent className="p-4">
                            <div className="text-center mb-3">
                              ...
                              <p
                                className={`text-2xl font-bold ${getBriColor(
                                  student.briScore
                                )}`}
                              >
                                {student.briScore}
                            ...
                            <div className="h-12">
                              <ResponsiveContainer width="100%" height="100%">
                                <LineChart
                                  data={generateSparklineData(student.trend)}
                                >
                                  <Line
                                    type="monotone"
                                    dataKey="y"
                            ...
                            <Badge
                              variant="outline"
                              className="w-full text-xs mt-2 justify-center"
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <ul className="text-sm text-blue-600 space-y-1">
                      <li>
                        • Schedule wellness check-ins for high-risk students
                      </li>
