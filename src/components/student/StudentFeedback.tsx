  ...
  const [submittedFeedback, setSubmittedFeedback] = useState([
    {
      ...
      response:
        "Thank you for your feedback! We're glad you're enjoying the new menu options.",
    },
    {
      id: "2",
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Share your thoughts anonymously to help improve our campus
        </p>
      </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2">
              {feedback.length}/1000 characters • Your identity will remain
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600">
                  {
                    submittedFeedback.filter((f) => f.status === "reviewed")
                      .length
                  }
                </p>
