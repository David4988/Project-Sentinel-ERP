...
const ChatBot: React.FC = () => {
  ...
  const getBotResponse = (input: string): string => {
    ...
    return (
      ...
      input +
      '". Could you please be more specific? I can help with BRI scores, attendance, assignments, and general campus information.'
    );
  };
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <Card className="fixed bottom-6 right-6 w-80 h-96 shadow-2xl z-50 flex flex-col bg-white">
