...
const StaffDashboard: React.FC<StaffDashboardProps> = ({ onPageChange }) => {
  ...
  const overallStats = {
    ...
    avgAttendance: Math.round(
      (cseKData.avgAttendance + cseDData.avgAttendance) / 2
    ),
  };
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Monitor student wellbeing across CSE-K and CSE-D classes
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* CSE-K Class Card */}
        <Card
          className="dashboard-card hover:shadow-lg transition-shadow cursor-pointer group"
          onClick={() => handleClassClick("CSE-K")}
        >
        ...
        <Card
          className="dashboard-card hover:shadow-lg transition-shadow cursor-pointer group"
          onClick={() => handleClassClick("CSE-D")}
        >
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-yellow-700 mt-1">
                CSE-K class showing increased BRI scores this week. Consider
                scheduling wellness check-ins.
              </p>
              <Button
                size="sm"
...
const StaffMain: React.FC<{
  ...
  switch (currentPage) {
    case "dashboard":
      return <StaffDashboard onPageChange={onPageChange} />;
    case "cse-k":
